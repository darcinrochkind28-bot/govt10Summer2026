---
title: "Week 2 · Class 1: Practice Exercises"
...
# Segment A — Introduction to R and Data Frames
```{r echo=F, include=F}
library(knitr)
library(formatR)
library(tidyverse)
...
**Dataset: data/congressional_leaders.csv**
...
# Load the dataset
library(tidyverse)
leaders <- read_csv("data/congressional_leaders.csv")
...
**Dataset: data/state_voting_patterns.csv**
...
```{r}
# Load the dataset
voting <- read_csv("data/state_voting_patterns.csv")
...
**Dataset: data/presidential_approval.csv**
...
```{r}
# Load the dataset
approval <- read_csv("data/presidential_approval.csv")
